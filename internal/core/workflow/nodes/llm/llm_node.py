...
from internal.core.workflow.nodes import BaseNode, LLMNodeData
...
class LLMNode(BaseNode):
    ...
    def invoke(self, state: WorkflowState, config: Optional[RunnableConfig] = None, **kwargs: Any) -> WorkflowState:
        ...
        # todo:3.根据配置创建LLM示例，等待多LLM接入时需要完善
        llm = ChatOpenAI(
            model=self.node_data.language_model_config.get("model", "moonshot-v1-8k"),
