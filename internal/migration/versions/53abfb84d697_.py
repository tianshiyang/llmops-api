...
Revision ID: 53abfb84d697
Revises: 3c010b1256b6
Create Date: 2025-08-11 17:57:08.710375
...
revision = '53abfb84d697'
down_revision = '3c010b1256b6'
branch_labels = None
depends_on = None
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('app', schema=None) as batch_op:
        batch_op.add_column(sa.Column('update_at', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP(0)'), autoincrement=False, nullable=False))
